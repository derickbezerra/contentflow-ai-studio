...
function planCards(): string {
  return `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:20px 0 6px;">
    <tr><td style="padding-bottom:8px;">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f8faf9;border-radius:12px;border:1.5px solid #e8efe9;">
        <tr><td style="padding:14px 18px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr>
            <td style="font-size:14px;font-weight:600;color:#1a2e23;">🌱&nbsp; Starter</td>
            <td align="right"><span style="font-size:13px;color:#6b7280;">10 gerações/mês</span>&nbsp;<span style="font-size:14px;font-weight:700;color:#1a2e23;">R$47</span></td>
          </tr></table>
        </td></tr>
      </table>
    </td></tr>
    <tr><td style="padding-bottom:8px;">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#1e4d35;border-radius:12px;">
        <tr><td style="padding:16px 18px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr>
            <td><span style="font-size:14px;font-weight:700;color:#ffffff;">🚀&nbsp; Growth</span>&nbsp;&nbsp;<span style="font-size:10px;font-weight:600;background:rgba(255,255,255,0.2);color:#fff;padding:3px 8px;border-radius:20px;letter-spacing:0.3px;">MAIS POPULAR</span></td>
            <td align="right"><span style="font-size:13px;color:rgba(255,255,255,0.7);">30 gerações/mês</span>&nbsp;<span style="font-size:14px;font-weight:700;color:#fff;">R$97</span></td>
          </tr></table>
        </td></tr>
      </table>
    </td></tr>
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f8faf9;border-radius:12px;border:1.5px solid #e8efe9;">
        <tr><td style="padding:14px 18px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr>
            ...
            <td align="right"><span style="font-size:13px;color:#6b7280;">50 gerações/mês</span>&nbsp;<span style="font-size:14px;font-weight:700;color:#1a2e23;">R$127</span></td>
          </tr></table>
        </td></tr>
      </table>
    </td></tr>
...
function examplePost(): string {
  return `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:8px 0 24px;">
    <tr><td style="background:#f8faf9;border-radius:12px;border-left:4px solid #1e4d35;padding:20px 22px;">
...
function tip(text: string): string {
  return `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;">
    <tr><td style="background:#f0f9f4;border-radius:10px;padding:14px 18px;">
